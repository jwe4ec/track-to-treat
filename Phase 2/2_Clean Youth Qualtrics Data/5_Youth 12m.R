...
warn_invalid_id_format(y12m_fixed_ids$lsmh_id)


### Remove invalid responses
# Filter to known valid LSMH IDs (marked "keep" in id_lookup) using helper function
y12m_valid_ids <- remove_invalid_p2_qualtrics_responses(y12m_fixed_ids, id_lookup)
